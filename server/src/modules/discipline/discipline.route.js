...
// Xóa quyết định: Chỉ Admin và HR_Human mới có quyền thực hiện
router.delete('/:id', authorize(['db_Admin', 'db_HR_Human']), disciplineController.deleteDisciplineRecord);
