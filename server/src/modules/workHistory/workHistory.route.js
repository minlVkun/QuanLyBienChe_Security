...
const workHistoryController = require('./workHistory.controller');
...
// POST: Nghiệp vụ Điều động / Bổ nhiệm (Atomic Transaction)
const { rlsMiddleware } = require('../../middlewares/rlsMiddleware');
router.post('/transfer', authorize(['db_Admin', 'db_HR_Human']), rlsMiddleware, workHistoryController.transferEmployee);
